...
{
u32 respLen;
HMAC(	EVP_sha1(),(unsigned char *)key,keyLen,(unsigned char *)chal,
		chalLen,(unsigned char *)resp,&respLen);
return;
}
...
AES_cbc_encrypt((unsigned char *)cryptText, (unsigned char *)plainText, cryptLen,
					&aeskey, (unsigned char *)tmpIV, AES_DECRYPT);
return;
}
